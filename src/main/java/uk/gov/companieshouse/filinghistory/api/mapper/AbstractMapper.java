...
public abstract class AbstractMapper {
    ...
    protected static boolean isDeltaStale(final OffsetDateTime requestDeltaAt, final String existingDeltaAt) {
        return !requestDeltaAt.isAfter(OffsetDateTime.parse(existingDeltaAt, FORMATTER));
    }
}
